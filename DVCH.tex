...
posterior sampling remain unexecuted; therefore no CMB/Planck posterior or
MCMC convergence is claimed here.
...
library. A real Planck posterior still additionally depends on the extracted
Planck \texttt{.clik} data files and the Cobaya likelihood wiring.
...
DVCH spectrum smoke test. The Planck posterior is not quoted because the
external \texttt{.clik} data files have not yet been connected to Cobaya.
